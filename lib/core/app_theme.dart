...
class AppTheme {
  ...
  static ThemeData light({ColorScheme? dynamicColor}) => _build(
        dynamicColor ??
  ...
  static ThemeData dark({ColorScheme? dynamicColor}) => _build(
        dynamicColor ??
            ColorScheme.fromSeed(
              seedColor: const Color(0xFF1A1A1A),
    ...
    return ThemeData(
      ...
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) return cs.onPrimaryContainer;
